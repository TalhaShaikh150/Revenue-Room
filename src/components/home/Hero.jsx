...
export function Hero() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setPopupState({ isOpen: true, status: "success", message: "Thanks! We'll start working on your growth tonight." });
        setEmail("");
      } else {
      ...
      setPopupState({ isOpen: true, status: "error", message: "Network error. Please try again." });
    } finally {
      setIsLoading(false);
    }
  };
