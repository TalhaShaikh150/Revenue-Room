        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          {offerings.map((item, index) => (
            <motion.div
              ...
              className="relative p-6 md:p-8 lg:p-12 flex flex-col group bg-[#0e0e10] border border-white/5 rounded-[24px] lg:rounded-[32px] overflow-hidden transition-all duration-500 hover:-translate-y-2 cursor-pointer"
            >
              ...
              <div className="relative z-10 flex items-center justify-between mb-8 lg:mb-16">
                <span className="text-brand-lime font-mono text-xs md:text-sm tracking-widest">
                  {item.num}
                </span>
