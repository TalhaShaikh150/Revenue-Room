          ...
          <div className="max-w-sm">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="relative flex h-3 w-3">
                <span
                  className="animate-ping absolute inline-flex h-full w-full rounded-sm bg-accent opacity-75"
            ...
            <p className="text-base leading-relaxed">
              We scale premium brands with our full-service execution, training
              academy, and fractional consultancy.
            </p>
          </div>
