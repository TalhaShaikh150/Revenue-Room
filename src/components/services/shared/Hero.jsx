        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            >
              ...
              <motion.h1 
                ...
                className="text-4xl md:text-5xl lg:text-[56px] xl:text-[64px] font-black leading-[1.05] tracking-tight mb-4 text-white"
              >
                {title}
              </motion.h1>
              ...
              <motion.p 
                variants={itemVariants} 
                className="text-white/60 text-base md:text-lg font-medium mb-8 leading-relaxed max-w-xl"
              >
                {description}
              </motion.p>
          ...
          <div className="lg:col-span-5 relative mt-8 lg:mt-0">
            <motion.div
              ...
              className="relative rounded-3xl overflow-hidden aspect-square lg:aspect-[4/3] bg-white/5 border border-white/10"
            >
              <img 
                src={imageSrc} 
                alt={typeof title === 'string' ? title : "Service Deliverables"} 
                className="w-full h-full object-cover mix-blend-luminosity opacity-70 hover:opacity-100 hover:scale-105 transition-all duration-700"
              />
            ...
            <motion.div 
              ...
              className="relative -mt-16 mx-6 md:mx-0 md:absolute md:-left-8 md:bottom-8 md:mt-0 z-20 bg-[#0a0a0c] border border-white/10 p-5 md:p-6 rounded-2xl shadow-2xl"
            >
